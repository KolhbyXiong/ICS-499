...
<head>
  ...
  <script src="test/unit/defaults.js"></script>
  <script src="test/unit/options.js"></script>
  <script src="test/unit/filter-find.js"></script>
  <script src="test/unit/remove.js"></script>
  <script src="test/unit/add-items.js"></script>
  <script src="test/unit/prepend.js"></script>
  <script src="test/unit/stamp.js"></script>
  <script src="test/unit/offset.js"></script>
<!-- <script src="item-on-transition-end.js"></script> -->
  <!-- with CellsByRow -->
  <script src="test/unit/create.js"></script>
  <script src="test/unit/layout.js"></script>
  <script src="test/unit/percent-position.js"></script>
  <script src="test/unit/hide-reveal.js"></script>
  <script src="test/unit/get-measurements.js"></script>
  <script src="test/unit/origin.js"></script>
  <script src="test/unit/transition-duration.js"></script>
  <script src="test/unit/container-size.js"></script>
  <script src="test/unit/destroy.js"></script>
  <script src="test/unit/declarative.js"></script>
  <script src="test/unit/jquery-plugin.js"></script>
